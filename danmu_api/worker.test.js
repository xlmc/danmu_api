...
test('worker.js API endpoints', async (t) => {
  ...
  await t.test('当前作品演员/角色名只按元数据精确过滤', () => {
    ...
    const input = [
      ...
      { p: '2,1,16777215,[test]', m: '张 三今天状态不错' },
      { p: '3,1,16777215,[test]', m: '这个角色叫林黛玉' },
      { p: '4,1,16777215,[test]', m: '王老师说得对' },
      { p: '5,1,16777215,[test]', m: 'Tom Hanks is great' },
      { p: '6,1,16777215,[test]', m: '盛明兰终于出场了' },
    ];
