...
| BLOCK_DOMESTIC_CELEBRITIES | 【可选】中国大陆演员/地区/当前作品角色名屏蔽开关，默认 `false`。开启后启用源码内置的 TMDB 中国大陆男/女热门演员各前 100 名及中国大陆省市地区名，并尝试动态叠加当前国产/港台作品的中文演员名、角色名及明确称谓/身份的姓氏指代（如“王老师”“欧阳导演”）；名单不在前台展示，不联网更新，也没有定时任务。`TMDB_API_KEY` 仅用于直连 TMDB 的认证，不是开启演员屏蔽的前置条件       |
